...
<figure id="example-figure" class="l-body-outset" style="text-align:center;">
  <div class="col one">
    <img src="{{ '../../assets/img/notes/lecture-01/diagram1.png' }}" style="width:80%; height:auto;" />
  </div>
</figure>
...
<figure id="example-figure" class="l-body-outset" style="text-align:center;">
  <div class="col one">
    <img src="{{ '../../assets/img/notes/lecture-01/bioexample.png' }}" style="width:80%; height:auto;" />
  </div>
</figure>
...
<figure id="example-figure" class="l-body-outset" style="text-align:center;">
  <div class="col one">
    <img src="{{ '../../assets/img/notes/lecture-01/supervised.png' }}" style="width:80%; height:auto;" />
  </div>
</figure>
...
<figure id="example-figure" class="l-body-outset" style="text-align:center;">
    <div class="col one">
      <img src="{{ '../../assets/img/notes/lecture-01/unsupervised.png' }}" style="width:80%; height:auto;" />
    </div>
</figure>
...
<figure id="example-figure" class="l-body-outset" style="text-align:center;">
  <div class="col one">
    <img src="{{ '../../assets/img/notes/lecture-01/reinforcement.png' }}" style="width:80%; height:auto;" />
  </div>
</figure>
